...
###############################################################################
# 1. AgentGateway Enterprise UI  →  4000:80
###############################################################################
hdr "1. AgentGateway Enterprise UI"
...
###############################################################################
# 2. Gloo Mesh Enterprise UI  →  8090:8090
###############################################################################
hdr "2. Gloo Mesh Enterprise UI"
...
trap 'echo ""; echo "Stopping port-forwards..."; kill "${PF_AGW_UI}" "${PF_GME}" "${PF_KC:-0}" 2>/dev/null || true' EXIT INT TERM
wait
