...
echo ""
echo "# Step 2: Get a Keycloak token from the realm endpoint (via AGW LB)"
echo "  # (no port-forward needed)"
echo "  TOKEN=\$(curl -s -X POST http://${AGW_LB}/realms/solo-demo/protocol/openid-connect/token \\"
